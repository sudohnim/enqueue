...
- **RELAYHOST.1 / QR.2** - deploy the relay on Railway (volume + env vars), then confirm off-LAN TLS + a phone sync on LTE with wifi off. Recipe in docs/PLAN.md + docs/sync-relay.md.
